...
ALLOWED_HOSTS = ["localhost", "ec2-54-80-239-34.compute-1.amazonaws.com"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "ec2-18-232-163-212.compute-1.amazonaws.com",  # Dirección IP de la base de datos
...
MQTT_HOST = "ec2-3-87-19-101.compute-1.amazonaws.com"
